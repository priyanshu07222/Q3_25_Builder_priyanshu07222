...
#[cfg(test)] mod tests {
    ...
    fn claim_airdrop() {
        ...
        println!("here is you public key: {}", keypair.pubkey().to_string());
    ...
    fn transfer_sol() {
        ...
        let to_pubkey = Pubkey::from_str("679iMf1mS2S4ajgQKJ1jnGgSDinLRxsjojYqJcEQeHeq").unwrap();
    ...
    fn enroll(){
        ...
        let seeds_collect = &[b"collection", collection.as_ref()];
        let (authority, _bump1) = Pubkey::find_program_address(seeds_collect,
        &turbin3_prereq_program);
